...
export function TestPanel({ config, extractedPrompt, onPromptChange }: TestPanelProps) {
  ...
  return (
    <>
      ...
      <div className={cn(
        "flex flex-col h-full w-full bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 overflow-hidden transition-all duration-300",
        isExpanded 
